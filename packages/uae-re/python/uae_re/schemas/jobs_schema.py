...
def validate_jobs_json(data) -> None:
    """
    Validate raw job postings JSON structure.

    Accepts BOTH:
    - Scraper format: list of page objects, each with "cards" list
    - Legacy format: dict with "listings"/"jobs"/"results" + "total_count"

    Args:
        data: Raw JSON data from job platform scraper (list or dict)
